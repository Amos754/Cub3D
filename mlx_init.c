...
void	ft_init_sprite(t_cub3d *cub3d)
{
	...
	i = -1;
	cub3d->texture[0].text = mlx_xpm_file_to_image(cub3d->mptr, cub3d->path_n, &width, &height);
	cub3d->texture[1].text = mlx_xpm_file_to_image(cub3d->mptr, cub3d->path_s, &width, &height);
	cub3d->texture[2].text = mlx_xpm_file_to_image(cub3d->mptr, cub3d->path_w, &width, &height);
	cub3d->texture[3].text = mlx_xpm_file_to_image(cub3d->mptr, cub3d->path_e, &width, &height);
	cub3d->g_t = mlx_xpm_file_to_image(cub3d->mptr, "texts/g.xpm", &width, &height);
	while (++i < 4)
...
{
	cub3d->mptr = mlx_init();
	cub3d->mlx_window = mlx_new_window(cub3d->mptr, screen_w, screen_h, "cub3d");
	cub3d->text = malloc(sizeof(t_textures));
	if (!cub3d->text)
		//free_function!
	// if (!cub3d->mptr) Add protection for
	// {
	// 	free(cub3d->mptr);
	...
	// cub3d->begin_image->text = mlx_new_image(cub3d->mptr, screen_w, screen_h);
	// if (!cub3d->text->text)
	...
	// mlx_put_image_to_window(cub3d->mptr, cub3d->mlx_window, cub3d->begin_image->text, 0, 0);
